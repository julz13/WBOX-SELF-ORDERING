...
{
    public partial class ucProceedBtn : UserControl
    {
        public ucProceedBtn()
        {
            InitializeComponent();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            int radius = 30; // Adjust the radius value to change the roundness
            ...
            int borderWidth = 4; // Adjust the border width as needed
